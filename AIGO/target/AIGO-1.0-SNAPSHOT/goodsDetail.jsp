...
<html>
	...
	<body>
			...
			<div class="top-bar">
				<div class="w1230 top-bar-main">
					<ul>
						...
						<li><a href="/shopcart.do"><i class="fa fa-shopping-cart"></i>购物车</a></li>
					</ul>
				</div>
			</div>
			<!--logo+搜索-->
		...
		<div class="w1230 clear-float goods-main">
			<div class="big-img">
				<img src="img/detail/big-detail.jpg" />
			</div>
			<div class="goods-detail">
				...
				<div class="update-num">
					...
					<a href="/addCart.do?addProductId=${productId}" id="addCart" title="添加购物车"><i class="fa fa-shopping-cart"></i>添加购物车</a><span id="tips"><i class="fa fa-check-circle-o"></i>添加成功</span>
				</div>
			</div>
			<!--店家承诺-->
			<div class="promise">
		...
		<div class="w1230 clear-float">
			...
			<div class="goods-des">
				...
				<div class="goods-info">
					<ul>
						<li><img src="img/detail/detail01.jpg" alt="" /></li>
						<li><img src="img/detail/detail02.jpg" alt="" /></li>
						<li><img src="img/detail/detail03.jpg" alt="" /></li>
						<li><img src="img/detail/detail04.jpg" alt="" /></li>
						<li><img src="img/detail/detail05.jpg" alt="" /></li>
						<li><img src="img/detail/detail06.jpg" alt="" /></li>
						<li><img src="img/detail/detail07.jpg" alt="" /></li>
						<li><img src="img/detail/detail08.jpg" alt="" /></li>
						<li><img src="img/detail/detail09.jpg" alt="" /></li>
					</ul>
				</div>
			</div>	
		</div>
